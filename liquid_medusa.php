...
<html lang="en">
	...
	<link rel="stylesheet" href="./css/common.css">
        <link rel="stylesheet" href="./css/liquid_medusa_style.css">
        ...
        <div id="wrap">
            ...
            <div id="content">                    
                <div class="page_name">
                    ...
                    <div class="name_txt"><span style="font-weight:500;">메두사 리퀴드&nbsp;</span>MEDUSA LIQUID</div>
                </div>
                <div class="nicotine_level">
                    <ul class="tab">
                        <li class="current" data-tab="tab1"><a href="#">천연니코틴0.95%</a></li>
                        <li data-tab="tab2"><a href="#">천연니코틴 0.30%</a></li>
                    </ul>
                </div>
                
                
                <div id="tab1" class="tabcontent current">
                    <?php include "./liquid_medusa_95.html"; ?>
                </div>
                <div id="tab2" class="tabcontent">
                    <?php include "./liquid_medusa_30.html"; ?>
                </div>
