...
<html lang="en">
	...
	<link rel="stylesheet" href="./css/common.css">
        <link rel="stylesheet" href="./css/certi_style.css">
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">                    
                <div class="page_name">
                    <div class="name_txt"><span style="font-weight:500;">인증서&nbsp;</span>Certification</div>
                </div>                
                
                <div class="certi_img">
                    <ul>
                        <li><div class='certi_name'>화학물질 확인서</div>
                            <a href='#'><div id="trigger-1" class='closer'></div></a>
                        </li>
                        <li><div class='certi_name'>수입신고수리 내역서</div>
                            <a href='#'><div id="trigger-2" class='closer'></div></a>
                        </li>
                        <li><div class='certi_name'>시험 보고서</div></li>
                        <li><div class='certi_name'>시험 보고서</div></li>
                        <li><div class='certi_name'>시험 보고서</div></li>
                        <li><div class='certi_name'>시험 보고서</div></li>
                        <li><div class='certi_name'>시험·검사성적서</div></li>
                        <li><div class='certi_name'>시험·검사성적서</div></li>
                    </ul>
                </div>
                
                <img id="img-popup" style="cursor:pointer;" src="./img/certi/certi_0.jpg" data-trigger="#trigger-1" alt="certi_0"/>
                <img id="img-popup2" style="cursor:pointer;" src="./img/certi/certi_1.jpg" data-trigger="#trigger-2"  alt="certi_1"/>
                
                <script>
                    $('#img-popup').popbox({theme:'dark', animation:'bringdown'});
                    $('#img-popup2').popbox({theme:'dark', animation:'bringdown'});
                </script>
