...
<html lang="en">
	...
	<link rel="stylesheet" href="./css/common.css">
        <link rel="stylesheet" href="./css/liquid_novo_style.css">
            ...
            <div id="content">                    
                ...
                <div class="nicotine_level">
                    <ul class="tab">
                        ...
                        <li data-tab="tab2"><a href="#">천연니코틴 0.20%</a></li>
                    </ul>
                </div>
                
                
                <div id="tab1" class="tabcontent current">
                    <?php include "./liquid_novo_95.html"; ?>
                </div>
                <div id="tab2" class="tabcontent">
                    <?php include "./liquid_novo_20.html"; ?>
                </div>
